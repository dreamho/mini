...
//        require APP . 'view/_templates/footer.php';
    ...
    public function addSong()
    {
        ...
        if (isset($_POST["submit_add_song"])) {
            ...
            $model->save();
            //$model->insert(['artist' => $_POST["artist"], 'track' => $_POST["track"], 'link' => $_POST["link"]]);
            //Capsule::table('song')->insert(['artist' => $_POST["artist"], 'track' => $_POST["track"], 'link' => $_POST["link"]]);
        }
