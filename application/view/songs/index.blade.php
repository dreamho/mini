...
<div id="all"></div>
    <script type="text/javascript">
        ...
        function deleteSong(id){
            ...
            xhr.open("get", "{{URL}}songs/deletesong/"+id, true);
            xhr.send();
        ...
        function get() {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        td5.innerHTML = '<a href="{{URL}}api/deletesong">delete</a>';
                        var td6 = document.createElement("td");
                        td6.innerHTML = '<a href="{{URL}}api/editsong">edit</a>';
            ...
            xhr.open("get", "{{URL}}api/getsongs", true);
            xhr.send();
